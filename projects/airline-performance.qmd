...
:::{.column-page-right}
<p class="text-center mb-0">Departure Delays by Airport (click legend to toggle groups)</p>
<iframe src="_dep-delay-airports.html" width="100%" height="600px"></iframe>
:::

:::{.column-page-right}
<p class="text-center mb-0">Arrival Delays by Airport (click legend to toggle groups)</p>
